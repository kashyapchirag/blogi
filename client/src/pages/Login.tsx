    ...
    return (
        <div className='bg-zinc-900 w-screen h-screen flex justify-center items-center text-white'>
            <div className="cont w-1/2 h-[67%] flex flex-col gap-7 justify-start items-center">
                ...
                <form onSubmit={handleSubmit} className='flex flex-col gap-5 bg-white text-black px-8 py-6 w-[55%] min-h-[50%] rounded-2xl' >
                    ...
                    <div className="button flex flex-col gap-2">
                        <button type='submit' className='bg-[#3498db] hover:bg-[#208dd5] py-2 cursor-pointer rounded-md text-zinc-100 font-bold'>Login</button>

                        <NavLink className={"text-black text-center text-[0.9rem]"} to={"/"}>Dont have an account <p className='inline text-blue-500'>Register</p></NavLink>
                    </div>
